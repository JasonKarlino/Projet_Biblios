 ...
 */
final class Version20250921142442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auteur RENAME COLUMN nom TO nom_prenom');
        $this->addSql('ALTER TABLE commentaire ALTER date_publication DROP NOT NULL');
        $this->addSql('ALTER TABLE editeur RENAME COLUMN nom TO nom_prenom');
    }
